...
{  display: flex;
  ...
  .custom-input input {
  background-color: rgba(255, 255, 255, 0.5); /* Màu nền với độ mờ 0.5 */
}
.error {
      margin-left: 12%;
      color: red;
        ...
        <div class="Login_form">
          <form method="post" action="sqlevent.php">
            <div class="input-group flex-nowrap custom-input">
              <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-laptop-code ico"></i></span>
              <input type="text" name="code"placeholder="Code here" class="form-control"  required />
            
            </div>
            <div class="error" id="error7"></div>
            <div class="input-group flex-nowrap custom-input" >
              <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-unlock-keyhole ico"></i></span>
              <input type="password" name="passwordn" placeholder="Password here" class="form-control"  required/>
              
            </div>
            <div class="error" id="error4"></div>
            <div class="input-group flex-nowrap custom-input">
              <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-key ico"></i></span>
              <input type="password" name="passwordconfn" placeholder="Password here too" class="form-control"  required/>
           
            </div>
            <div class="error" id="error5"></div>

            <div class="parent-container">
              <input type="submit" name="confirm-change" value="confirmation" class="btn btn-outline-light">
            </div>
          ...
          <div class="small text-white-50 parent-container">
            have an account?
            <a href="#" onclick="registerForm()">Login now</a>
          </div>
